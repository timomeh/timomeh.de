...
export default function PrivacyPolicy() {
  return (
    <Prose>
      ...
      <p>E-Mail: kontakt@maemecke.com</p>
      <p>
      ...
      <h3>SoundCloud</h3>
      <p>
        Auf dieser Website k&ouml;nnen Plugins des sozialen Netzwerks SoundCloud
      ...
      <p>
        ...
        &bdquo;Like-Button&ldquo; oder &bdquo;Share-Button&ldquo; anklicken,
        w&auml;hrend Sie in Ihrem SoundCloud- Benutzerkonto eingeloggt sind,
        k&ouml;nnen Sie die Inhalte dieser Website mit Ihrem SoundCloud-Profil
        verlinken und/oder teilen. Dadurch kann SoundCloud Ihrem Benutzerkonto
        den Besuch dieser Website zuordnen. Wir weisen darauf hin, dass wir als
        Anbieter der Seiten keine Kenntnis vom Inhalt der &uuml;bermittelten
        Daten sowie deren Nutzung durch SoundCloud erhalten.
      </p>
      <p>
      ...
      <p>
        ...
        das dem Datenschutzniveau in der Europ&auml;ischen Union entspricht.
      </p>
      <p>
      ...
      <p>
        Wenn Sie nicht w&uuml;nschen, dass SoundCloud den Besuch dieser Website
