    ...
    <div>
      {lightCover && (
        <div
          ...
          className="
            relative isolate flex h-auto max-h-[400px] w-full items-end overflow-hidden rounded-t-xl
            [mask-image:linear-gradient(to_bottom,#000_95%,transparent_100%)] mix-blend-darken
      ...
      {darkCover && (
        <div
          className="
            relative isolate hidden h-auto max-h-[400px] w-full items-end overflow-hidden
