...
export function GlassPill({ children }: Props) {
  return (
    <div
      className="
        shadow-beige/15 relative isolate overflow-hidden rounded-full border border-x-[#E8CABE]
        border-t-[#EEDED8] border-b-[#E8CABE] shadow-md
    ...
    >
      ...
      <div
        className="
          xs:text-sm
          relative z-30 px-3 py-1 text-center text-xs font-medium text-amber-950 tabular-nums
          opacity-70
          dark:text-emerald-200 dark:antialiased
