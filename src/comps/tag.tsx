...
export function Tag({ title, active }: Props) {
  return (
    <div
      data-active={active}
      className="
        max-w-full truncate rounded-full border border-gray-200 bg-gray-500/3
        px-2 py-1 text-xs leading-none font-medium text-gray-700 transition
        group-hover/btn:border-gray-300 group-hover/btn:bg-gray-500/7
        group-hover/btn:shadow-md/5
