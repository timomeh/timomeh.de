  ...
  if (isInline) {
    return (
      <code
        {...props}
        className="
          -my-1 rounded-md border border-gray-400/50 bg-white/30 px-1.5 py-1
  ...
  return (
    ...
    >
      ...
      {lang && !hiddenLangs.includes(lang) && <span className={`
        text-2xs absolute top-0 right-0 rounded-tr rounded-bl px-1.5 pt-1 pb-1
        leading-none font-bold text-[#1a1b26] uppercase select-none
