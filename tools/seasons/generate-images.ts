...
DO NOT use any location descriptions. DO NOT use "cobblestone" or "church" or "riverside" or "quay". Focus purely on the weather condition.
...
The scene you're creating is in an urban area, and add the weather conditions and daytime into the scene. Ignore any location details like "cobblestone streets" and "river" and "town" that the weather report may contain.
